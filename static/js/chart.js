...
// sample data
var sample = [
{ id:1001, name: 'Positivo',       count: 3 },
{ id:1002, name: 'Neutro',           count: 2 },
{ id:1003, name: 'Negativo',        count: 4 },
];
...
$('#bt_descartar').on('click', function() {
